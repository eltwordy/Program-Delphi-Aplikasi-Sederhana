...
uses
  ...
  Dialogs, ComCtrls, StdCtrls, ExtCtrls, vfw, ExtDlgs, Videocap;
...
type
  TForm1 = class(TForm)
    ...
    procedure ButtonNameFileClick(Sender:TObject);
    ...
    procedure VideoCap1StatusCallback(Sender:TObject; nID:Integer; status:String);
...
procedure TForm1.VideoCap1StatusCallback(Sender:TObject; nID:
Integer;
Status: String);
begin
